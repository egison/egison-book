...
\begin{center}
    ...
    関数名 & 関数の内容 \\ \hline
    \texttt{return} & \\ \hline
    \texttt{openInputFile} &  \\ \hline
    \texttt{openOutputFile} &  \\ \hline
    \texttt{closeInputPort} &  \\ \hline
    \texttt{closeOutputPort} &  \\ \hline
    \texttt{readChar} &  \\ \hline
    \texttt{readLine} &  \\ \hline
    \texttt{writeChar} &  \\ \hline
    \texttt{write} &  \\ \hline
    \texttt{readCharFromPort} &  \\ \hline
    \texttt{readLineFromPort} &  \\ \hline
    \texttt{writeCharToPort} &  \\ \hline
    \texttt{writeToPort} &  \\ \hline
    \texttt{isEof} &  \\ \hline
    \texttt{flush} &  \\ \hline
    \texttt{isEofPort} &  \\ \hline
    \texttt{flushPort} &  \\ \hline
    \texttt{readFile} &  \\ \hline
    \texttt{rand} &  \\ \hline
    \texttt{f.rand} &  \\ \hline
    \texttt{newIORef} &  \\ \hline
    \texttt{writeIORef} &  \\ \hline
    \texttt{readIORef} &  \\ \hline
    \texttt{readProcess} &  \\ \hline
    \end{tabular}
\end{center}
