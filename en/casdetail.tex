...
For example, if we introduce a symbol \lstinline{sqrt2} representing $\sqrt{2}$ and register the automatic rule $\sqrt{2}^2 = 2$, the rule is applied automatically on every arithmetic operation.
\begin{lstlisting}[language=egison,numbers=none]
