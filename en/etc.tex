...
An example of making the \lstinline{MathValue} type an instance of the algebraic type class hierarchy is as follows.
...
Note: In Egison, \lstinline{MathValue}, \lstinline{Integer}, and \lstinline{Rational} are identified with each other, so \lstinline{isInteger} and \lstinline{isRational} are used to determine properties of numerical values in the computer algebra system.
